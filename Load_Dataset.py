...
class ImageToImage2D(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #new_filename = image_filename.replace("_trainin", "")[:-4] + "_manual1.gif"
        #mask = cv2.imread(os.path.join(self.output_path,  image_filename.replace("_training", "_manual1")[:-3] + "gif"),0)
        #mask = cv2.imread(os.path.join(self.output_path, image_filename[: -4] + "_anno.png"),0)
        #mask = cv2.imread(os.path.join(self.output_path, image_filename[: -4] + "_1stHO.png"),0)
        #print("mask",image_filename.replace("_training", "_manual1")[:-3] + "gif")
